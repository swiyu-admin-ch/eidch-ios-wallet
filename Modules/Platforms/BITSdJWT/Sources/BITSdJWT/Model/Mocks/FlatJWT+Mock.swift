...
extension FlatJWT: Mockable {
  ...
  struct Mock {
    ...
    static let keyBindingJwt = "KEY.BINDING.JWT"
    static let dataWithKeyBinding = JWS.sdJWSData(with: disclosures, keyBindingJWT: keyBindingJwt)
    ...
    static let withoutSdAlgData = withoutSdAlg.sdJWSData(with: disclosures)
    ...
    private static let withoutSdAlg = "eyJ0eXAiOiJmbGF0IiwiYWxnIjoiRVMyNTYifQ.eyJfc2QiOlsiWVJMZjYwNmNsd3Q0LWhqeUd6ZTQ5eVNGaTZWQ213YjluNWh3YjRWVUpTWSIsIlFodXZJTVFkNUx5WDhnT1Izd2VWelNZMHlHWkdHSGRWWFkwRS1OaGhVZnciLCJxbDZ5Qk1iLTVRbDFnRzgzM0oxbzNwb0ZJRExWdDlDazc5YXN0UWVWWWIwIl19.H4b1enhprd8zfDBF-Vv7EPLe_cJw7j4nsjfmJ4DEuBtVnk0YNgq2GjCq_I4FR8BuAFG4rGajT4K2axpgSXwntg"
  }
}
