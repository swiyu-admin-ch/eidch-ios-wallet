...
enum Assets {
  ...
  static let cameraRotate = ImageAsset(name: "CameraRotate")
  ...
  static let nfc = ImageAsset(name: "Nfc")
  static let nfcFailure = ImageAsset(name: "NfcFailure")
  static let passport = ImageAsset(name: "Passport")
  static let person = ImageAsset(name: "Person")
  static let questionMark = ImageAsset(name: "QuestionMark")
  static let scanDocumentPreview = ImageAsset(name: "ScanDocumentPreview")
  ...
  static let blurry = ImageAsset(name: "blurry")
  static let cameraSlash = ImageAsset(name: "camera.slash")
  static let documentSlash = ImageAsset(name: "document.slash")
  static let reflections = ImageAsset(name: "reflections")
  static let scanDocument = ImageAsset(name: "scan.document")
  static let scanFaceSlash = ImageAsset(name: "scan.face.slash")
  static let scanPassport = ImageAsset(name: "scan.passport")
  static let unknown = ImageAsset(name: "unknown")
  static let videoSlash = ImageAsset(name: "video.slash")
}
