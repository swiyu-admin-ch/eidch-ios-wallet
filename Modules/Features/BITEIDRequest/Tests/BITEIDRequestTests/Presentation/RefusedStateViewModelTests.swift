...
@MainActor
class RefusedStateViewModelTests: XCTestCase {
  ...
  func testInitialState() throws {
    viewModel = try RefusedStateViewModel(requestCase: mockRequestCase, delegate: delegate)
  ...
  private var viewModel: RefusedStateViewModel!
