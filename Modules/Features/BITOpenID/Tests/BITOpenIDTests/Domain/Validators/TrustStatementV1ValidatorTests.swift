...
final class TrustStatementV1ValidatorTests: XCTestCase {
  ...
  override func setUp() {
    ...
    registerMocks()
    validator = TrustStatementV1Validator()
    createSuccessState()
  }
  ...
  func testValidate_wrongSubject_returnsFalse() async {
    let trustStatement = IdentityTrustStatementV1JWT.Mock.wrongSubject
  ...
  func testValidate_wrongAlgorithm_returnsFalse() async {
    let trustStatement = IdentityTrustStatementV1JWT.Mock.wrongAlgorithm
  ...
  private let trustStatementMock = IdentityTrustStatementV1JWT.Mock.validSample
  private let subjectMock = "subject"
  private let issuerMock = "did"

  private var jwsValidatorMock: JWSValidatorMock<IdentityTrustStatementV1JWT>!
  ...
  private var validator: TrustStatementV1Validator!
