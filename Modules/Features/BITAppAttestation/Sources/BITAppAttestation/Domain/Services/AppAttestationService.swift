...
// MARK: - AppAttestationServiceProtocol

@Spyable
protocol AppAttestationServiceProtocol {
...
// MARK: - AppAttestationService

struct AppAttestationService: AppAttestationServiceProtocol {
  ...
  func generateAttestedKey(with challenge: AttestationChallenge) async throws -> AppAttestedKey {
    ...
    guard let challengeData = challenge.data(using: .utf8) else {
      throw AppAttestationServiceError.invalidChallenge
    }
...
// MARK: - AppAttestationServiceError

enum AppAttestationServiceError: Error {
