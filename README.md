...
For more information about the project please visit the [introduction into Sandbox](https://www.eid.admin.ch/en/sandbox-e). The technical documentation of the swiyu Sandbox Trust Infrastructure can be found [here](https://swiyu-admin-ch.github.io/).
